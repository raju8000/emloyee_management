...
class _CalendarDatePicker2State extends State<CalendarDatePicker2> {
  ...
  String buttonSelected = Strings.today;

  @override
  void initState() {
    super.initState();
    if(!widget.isFromDate){
      buttonSelected = Strings.noDate;
    }
            ...
            children: [
              Expanded(
                child: RoundedCornerButton(
                  text: Strings.today,
                  fontSize: 10.sp,
                  backgroundColour: buttonSelected==Strings.today?PrimaryBlue:LightBlue,
                  textColor: buttonSelected==Strings.today?null:PrimaryBlue,
                  cornerRadius: 4,
                  onPressed: (){
                    setState(() {
                      buttonSelected = Strings.today;
                      _selectedDates = [DateTime.now()];
                      _currentDisplayedMonthDate = _selectedDates[0]!;
                      widget.onValueChanged?.call(_selectedDates);
                    });
                  },
                ),
              ...
              Expanded(
                child: RoundedCornerButton(
                  text: Strings.nextMonday,
                  fontSize: 10.sp,
                  backgroundColour: buttonSelected==Strings.nextMonday?PrimaryBlue:LightBlue,
                  textColor: buttonSelected==Strings.nextMonday?null:PrimaryBlue,
                  cornerRadius: 4,
                  onPressed: (){
                    setState(() {
                      buttonSelected = Strings.nextMonday;
                      var today = DateTime.now();
                      int nextMonday = (DateTime.monday - today.weekday) % DateTime.daysPerWeek;
                      _selectedDates = [today.add(Duration(days: nextMonday == 0? 7: nextMonday))];
                      _currentDisplayedMonthDate = _selectedDates[0]!;
                      widget.onValueChanged?.call(_selectedDates);
                    });
                  },
            ...
            children: [
              Expanded(
                child: RoundedCornerButton(
                  text: Strings.noDate,
                  fontSize: 10.sp,
                  backgroundColour: buttonSelected==Strings.noDate?PrimaryBlue:LightBlue,
                  textColor: buttonSelected==Strings.noDate?null:PrimaryBlue,
                  cornerRadius: 4,
                  onPressed: (){
                    setState(() {
                      buttonSelected = Strings.noDate;
                      widget.onDateSelect?.call(true);
                    });
                  },
                ),
              ),
        ...
        Padding(
          ...
          child: Row(
            children: [
              Expanded(
                child: RoundedCornerButton(
                  text: Strings.nextTuesday,
                  fontSize: 10.sp,
                  backgroundColour: buttonSelected==Strings.nextTuesday?PrimaryBlue:LightBlue,
                  textColor: buttonSelected==Strings.nextTuesday?null:PrimaryBlue,
                  cornerRadius: 4,
                  onPressed: (){
                    setState(() {
                      buttonSelected = Strings.nextTuesday;
                      var today = DateTime.now();
                      int nextTuesday = (DateTime.tuesday - today.weekday) % DateTime.daysPerWeek;
                      _selectedDates = [today.add(Duration(days: nextTuesday == 0? 7: nextTuesday))];
                      widget.onValueChanged?.call(_selectedDates);
                    });
                  },
                ),
              ...
              Expanded(
                child: RoundedCornerButton(
                  text: Strings.afterOneWeek,
                  cornerRadius: 4,
                  fontSize: 10.sp,
                  backgroundColour: buttonSelected==Strings.afterOneWeek?PrimaryBlue:LightBlue,
                  textColor: buttonSelected==Strings.afterOneWeek?null:PrimaryBlue,
                  onPressed: (){
                    setState(() {
                      buttonSelected = Strings.afterOneWeek;
                      var today = DateTime.now();
                      _selectedDates = [today.add(const Duration(days:  7))];
                      _currentDisplayedMonthDate = _selectedDates[0]!;
                      widget.onValueChanged?.call(_selectedDates);
                    });
                  },
      ...
      child: Column(
        children: <Widget>[
          Container(
            padding: widget.config.centerAlignModePicker != true
                ? const EdgeInsetsDirectional.only(start: 16, end: 4)
                : const EdgeInsetsDirectional.only(start: 0, end: 8),
            height: (widget.config.controlsHeight ?? _subHeaderHeight),
            child: Row(
              ...
              children: <Widget>[
                ...
                if (widget.config.centerAlignModePicker == true) const SizedBox(width: 150,),
                IconButton(
